...
(function($, window, document, undefined) {
  ...
  SelectUI.prototype = {
    ...
    render: function() {
      ...
      this.jSelectContainerUI.width(settings.width).height(settings.height).css({
        "line-height": settings.height + "px"
      });
      this.jSelectIconUI.width(settings.height).height(settings.height);
      this.jSelectListUI.css({
      ...
      this.jSelectListUI.html(optionHTML).css({
        "max-height": settings.height * 4
      });
    ...
    bindEvent: function() {
      ...
      $("#" + this.selectContainerUI).hover(function() {}, function() {
        that.close();
      });
